...
const seasonData = {
  ...
  s3: {
    ...
    episodes: [
      ...
      {
        title: "2025 #39 - AGI não vira no Natal! Panetone, Maratona de IA, Palavras do Ano",
      ...
      {
        title:
          "2025 #36 - Black Friday dos Agentes: IA, Excel com Claude e a maratona que vai turbinar sua carreira em 2026",
